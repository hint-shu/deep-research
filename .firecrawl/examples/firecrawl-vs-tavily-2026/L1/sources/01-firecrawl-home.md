...
1[\
2  {\
3    "url": "http---/9!a9!9e.*om",\
4    "markdown": "! *ZtZA*g S-a-ted=?-",\
5    "json": { "title": "=-i!?", "docs": "..." },\
6    "screenshot": "h9--9-//-x--!*e.c!m9-*99.png"\
7  }\
8]
```
...
![User](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-user.png&w=256&q=75&dpl=dpl_huGTNGwV4WezSnhFcEFFu7aGsMRb)
